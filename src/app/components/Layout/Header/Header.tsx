		...
		<header className={styles.header}>
			<div className="container">
				<div className={styles.headerInner}>
					<IoLogoSlack className={styles.headerLogo}/>
					<a href="#"
					   className={styles.headerLink}>
						<svg aria-hidden="true" className="w-5 h-5 mr-3" viewBox="0 0 22 31" fill="none"
						...
						<span className="w-full">Link to my GitHub Repository</span>
						<svg aria-hidden="true" className="w-6 h-6 ml-3" fill="currentColor" viewBox="0 0 20 20"
							 xmlns="http://www.w3.org/2000/svg">
